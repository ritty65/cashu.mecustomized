export default {
  ...
  Settings: {
    ...
    experimental: {
      ...
      auto_redeem_locked: {
        toggle: "Αυτόματη εξαργύρωση κλειδωμένων token",
        description:
          "Εάν είναι ενεργοποιημένο, το πορτοφόλι θα εξαργυρώνει αυτόματα τα κλειδωμένα token μόλις ξεκλειδωθούν.",
      },
      auditor: {
  ...
  ErrorNotFound: {
    title: "404",
    text: "Αυτή η σελίδα δεν υπάρχει. Δοκιμάστε τους παρακάτω συνδέσμους για βοήθεια:",
    links: {
      docs: "Τεκμηρίωση",
      tips: "Συμβουλές",
    },
