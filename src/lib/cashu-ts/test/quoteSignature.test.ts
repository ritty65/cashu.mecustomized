...
describe("mint quote signatures", () => {
	test("valid signature verification", () => {
		...
		expect(verifyMintQuoteSignature(pubkey, quote, blindedMessages, sig)).toBe(
			true,
		);
	});
	...
	test("signature creation", () => {
		...
		expect(
			verifyMintQuoteSignature(pubkey, quote, blindedMessages, signature),
		).toBe(true);
	});
});
